...
const getAllStudentById = (data) => {
  return axios.get(
    `/api/get-all-student-by-id?limit=${data.limit}&offset=${data.offset}&keyword=${data.keyword}&roomId=${data.roomId}`
  );
};
const setLeaderService = (data) => {
  return axios.put(`/api/set-leader`, data);
};
...
const getAllProductDetailByIdService = (data) => {
  return axios.get(
    `/api/get-all-product-detail-by-id?id=${data.id}&limit=${data.limit}&offset=${data.offset}`
  );
};
const getAllProductDetailImageByIdService = (data) => {
  return axios.get(
    `/api/get-all-product-detail-image-by-id?id=${data.id}&limit=${data.limit}&offset=${data.offset}`
  );
};
...
const getProductShopcartService = (data) => {
  return axios.get(
    `/api/get-product-shopcart?userId=${data.userId}&limit=${data.limit}`
  );
};
...
//======================STATISTIC========================//
const getCountCardStatistic = (id) => {
  return axios.get(`/api/get-new-message?userId=${id}`);
};
const getNewRegister = () => {
  return axios.get(`/api/get-new-register`);
};
const getNewComplaint = () => {
  return axios.get(`/api/get-new-complaint`);
};
const getUser = () => {
...
const getAllUsers = (data) => {
  return axios.get(
    `/api/get-all-user?limit=${data.limit}&offset=${data.offset}&keyword=${data.keyword}&roleId=${data.roleId}`
  );
};
const getAllStudentAvailableService = (id) => {
  return axios.get(`/api/get-all-student-to-add-roomBed-by-id?id=${id}`);
};

const blockUserService = (id) => {
  return axios.put(`/api/block-user?id=${id}`);
};
const deleteUser = (id) => {
...
const getHistory = (data) => {
  return axios.get(
    `/api/get-history?limit=${data.limit}&offset=${data.offset}&keyword=${data.keyword}`
  );
};
const getHistoryDetailById = (id) => {
  return axios.get(`/api/get-history-detail-by-id?id=${id}`);
};
