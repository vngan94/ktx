...
import {getTypeRoomImageByIdService} from "../../../services/typeRoomImageService"
    ...
    useEffect(() => {
        ...
        if (id) {
            let fetchProductImage = async () => {
                let res = await getTypeRoomImageByIdService(id)
        ...
        <div className="">
            ...
            >
                <div className="modal-header">
                    <h5 className="modal-title">Thêm hình ảnh loại phòng</h5>
